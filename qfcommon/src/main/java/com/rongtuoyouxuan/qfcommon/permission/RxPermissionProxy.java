package com.rongtuoyouxuan.qfcommon.permission;
        ...
        mPermissions.requestEachCombined(Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE)
                .subscribe(permission -> {
                    if (permission.granted) {
                        ...
                        builder.setTitle(mContext.getString(com.zhihu.matisse.R.string.permission_camrea));
                        builder.setNegativeButton(com.zhihu.matisse.R.string.cancel, new DialogInterface.OnClickListener() {
                            @Override
                        ...
                        builder.setPositiveButton(mContext.getString(com.zhihu.matisse.R.string.to_allow), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                //跳转系统权限设置
