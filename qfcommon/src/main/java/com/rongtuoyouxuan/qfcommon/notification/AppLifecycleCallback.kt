    ...
    private val mFragmentLifecycleCallbacks: FragmentManager.FragmentLifecycleCallbacks =
        object : FragmentManager.FragmentLifecycleCallbacks() {
            ...
            override fun onFragmentResumed(fm: FragmentManager, f: Fragment) {
                ...
                //获取Activity弱引用
                ForegroundActivityManager.getInstance().setCurrentPage(f.activity, f)
            }
            ...
            override fun onFragmentPaused(fm: FragmentManager, f: Fragment) {
                ...
                //获取Activity弱引用
                ForegroundActivityManager.getInstance().currentActivityMap.clear()
            }
...
//        ForegroundActivityManager1.getInstance().setCurrentActivity(activity)
    ...
    override fun onActivityResumed(activity: Activity) {
        //获取Activity弱引用
        ForegroundActivityManager.getInstance().setCurrentPage(activity, null)
    }
