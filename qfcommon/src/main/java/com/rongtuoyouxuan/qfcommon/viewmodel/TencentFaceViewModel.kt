...
import com.rongtuoyouxuan.chatlive.biz2.face.FaceIdBiz
import com.rongtuoyouxuan.chatlive.biz2.model.face.FaceIdBean
import com.rongtuoyouxuan.chatlive.biz2.model.face.FaceIdResultBean
import com.rongtuoyouxuan.chatlive.biz2.model.face.FaceIdStatusBean
...
class TencentFaceViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun sendTencentFaceResult(sim: String,
                    order_no: String,
                    userId: String) {
        FaceIdBiz.sendTencentFaceResult(sim, order_no, userId, object : RequestListener<FaceIdResultBean> {
    ...
    fun getTencentIdentificationStatus(userId: String) {
        FaceIdBiz.getTencentIdentificationStatus(userId, object : RequestListener<FaceIdStatusBean> {
