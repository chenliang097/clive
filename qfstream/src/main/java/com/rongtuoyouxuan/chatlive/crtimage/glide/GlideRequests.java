...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.rongtuoyouxuan.chatlive.crtimage.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.rongtuoyouxuan.chatlive.crtimage.glide.GlideOptions().apply(toSet));
    }
  }
}
