...
interface StreamServer {
    ...
    fun liveFollows(
        @Body request: LiveFollowsReq): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    fun audienceExitRoom(@Body request: AudienceExitRoomRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @GET("/audience/live/shares")
    fun getShareInfo(): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @POST("/audience/shared/live")
    fun sharedLive(@Body request: ShareLiveRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @GET("/live/classify")
    fun getLiveType(@Query("live_id") streamId: String): Call<LiveTypeBean>

    @POST("/anchor/debug/log")
    fun uploadPushStreamInfo(@Body request: PushStreamInfoRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    @POST("/medium/v1/room/userLiking")
    fun liveZan(@Body request: LiveZanReq): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @POST("/userProxy/v1/user/faceIdentification")
    fun getTencentFaceData(@Body request: LiveZanReq): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @POST("/medium/v1/push/showTime")
    fun uploadAnchorInfo(@Body request: StartPushStreamRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @POST("/userProxy/v1/user/setAllowRule")
    fun setUserAllowRange(@Body request: LiveRoomVisibleRangeRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    fun delRoomManager(@Body request: AnchorRoomSettingRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    fun relieveRoomBlack(@Body request: BlacklistRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    fun relieveRoomMute(@Body request: MuteRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    fun setRoomMaskWord(@Body request:SetRoomMaskWordsRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>

    @POST("/userProxy/v1/user/delShieldWord")
    fun deleteRoomMaskWord(@Body request:SetRoomMaskWordsRequest): Call<com.rongtuoyouxuan.chatlive.crtnet.BaseModel>
    ...
    @POST("/medium/v1/push/getCloseInfo")
    fun getStreamEndInfo(@Body request:StreamEndRequest): Call<StreamEndBean>
