package com.rongtuoyouxuan.chatlive.crtmagicindicator.buildins.commonnavigator.indicators;
...
import com.rongtuoyouxuan.chatlive.crtmagicindicator.FragmentContainerHelper;
import com.rongtuoyouxuan.chatlive.crtmagicindicator.buildins.ArgbEvaluatorHolder;
...
import com.rongtuoyouxuan.chatlive.crtmagicindicator.buildins.commonnavigator.model.PositionData;
 ...
 */
public class LinePagerSelecteIndicator extends View implements IPagerIndicator {
    ...
    public LinePagerSelecteIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mLinePaint.setColor(Color.parseColor("#fc612b"));//设置边框的颜色
        canvas.drawRoundRect(mLineRect, mRoundRadius, mRoundRadius, mLinePaint);
    }
