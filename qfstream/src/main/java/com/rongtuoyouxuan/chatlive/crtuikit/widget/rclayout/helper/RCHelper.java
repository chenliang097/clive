...
package com.rongtuoyouxuan.chatlive.crtuikit.widget.rclayout.helper;
...
public class RCHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.pl_libuikit_RCAttrs);
        mRoundAsCircle = ta.getBoolean(R.styleable.pl_libuikit_RCAttrs_round_as_circle, false);
        mStrokeColorStateList = ta.getColorStateList(R.styleable.pl_libuikit_RCAttrs_stroke_color);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.pl_libuikit_RCAttrs_stroke_width, 0);
        mClipBackground = ta.getBoolean(R.styleable.pl_libuikit_RCAttrs_clip_background, false);
        int roundCorner = ta.getDimensionPixelSize(R.styleable.pl_libuikit_RCAttrs_round_corner, 0);
        int roundCornerTopLeft = ta.getDimensionPixelSize(
                R.styleable.pl_libuikit_RCAttrs_round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta.getDimensionPixelSize(
                R.styleable.pl_libuikit_RCAttrs_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                R.styleable.pl_libuikit_RCAttrs_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                R.styleable.pl_libuikit_RCAttrs_round_corner_bottom_right, roundCorner);
        ta.recycle();
