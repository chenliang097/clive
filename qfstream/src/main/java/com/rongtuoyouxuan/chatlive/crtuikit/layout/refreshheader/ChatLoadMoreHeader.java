package com.rongtuoyouxuan.chatlive.crtuikit.layout.refreshheader;
 ...
 * 描述
 */
public class ChatLoadMoreHeader extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ChatLoadMoreHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChatLoadMoreHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        if (REFRESH_FOOTER_PULLING == null) {
            REFRESH_FOOTER_PULLING = context.getString(R.string.srl_load_more_pulling);
        }
