...
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.callback.KiwiCallback;
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.capture.VideoCaptureFromCamera2;
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.entity.FaceDetection;
...
public class SDKManager {
    ...
    private ArrayList<String> copyResourcesInfoList(Context context) {
        ...
        ArrayList resourcesInfoList = new ArrayList<String>();
...
//                "；height = " + height);
    ...
    public void greenScreenSplit(int param) {
        Log.v(TAG, "greenScreenSplit: "+param);

        ZegoEffectsChromaKeyParam chromaKeyParam = new ZegoEffectsChromaKeyParam();
        chromaKeyParam.similarity = param;
        chromaKeyParam.setSmoothness(80);
        chromaKeyParam.setBorderSize(1);
        chromaKeyParam.setOpacity(100);
        chromaKeyParam.setKeyColor(0x00ff00);
...
//        videoCaptureFromCamera2.startRenderAllEffects();
    ...
    public List<PreviewSize> getSupportedPreviewSizes() {
        ...
        List<Camera.Size> sizes = videoCaptureFromCamera2.getSupportedPreviewSizes();
    ...
    public void processImageBufferRGB(byte[] byteArray,ZegoEffectsVideoFrameParam zegoEffectsVideoFrameParam){
        synchronized (object) {
            if(isInit) {
                Log.e("asdasd","processImageBufferRGB");
                zegoEffects.processImageBufferRGB(byteArray, byteArray.length, zegoEffectsVideoFrameParam);
