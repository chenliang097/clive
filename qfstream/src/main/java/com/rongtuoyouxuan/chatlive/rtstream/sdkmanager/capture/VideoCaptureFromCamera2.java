package com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.capture;
...
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.egl.EglBase;
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.egl.EglBase14;
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.egl.GlRectDrawer;
import com.rongtuoyouxuan.chatlive.rtstream.sdkmanager.egl.GlUtil;
...
//                Matrix.translateM(mPreviewMatrix, 0, ((1.0f - fWidthScale) / 2.0f), ((1.0f - fHeightScale) / 2.0f), 1.0f);
    ...
    public List<Camera.Size> getSupportedPreviewSizes() {
        if (mParms != null) {
            ...
            return mParms.getSupportedPreviewSizes();
        }
