...
import com.rongtuoyouxuan.chatlive.crtbiz2.user.PayBiz.getPayOrderInfo
...
class PayTypeDialog : LanguageActivity(), View.OnClickListener {
    ...
    private fun doBuy() {
        val payInfo = PayInfoRequest(payType, 1, com.rongtuoyouxuan.chatlive.crtdatabus.DataBus.instance().USER_ID, 2)
