...
class WalletActivity : SimpleActivity(), View.OnClickListener {
    ...
    override fun initData() {
        ...
        goldBuyGridAdapter!!.setBuyGoldClickListener(object :
            GoldBuyGridAdapter.BuyGoldClickListener {
    ...
    private fun getBalance(){
        PayBiz.getMyWallet(com.rongtuoyouxuan.chatlive.crtdatabus.DataBus.instance().USER_ID, object :
            RequestListener<WalletBean> {
