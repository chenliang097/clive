 ...
 */
package com.rongtuoyouxuan.chatlive.crtutil.permission;
...
import com.rongtuoyouxuan.chatlive.crtutil.permission.source.Source;
...
public class RuntimeSettingPage {
    ...
    public static final String OPPO_VERSION_NAME = "ro.build.version.opporom";
    private static final String MIUI_VERSION_NAME = "ro.miui.ui.version.name";
    private static final String VIVO_VERSION_NAME = "ro.vivo.os.version";
    ...
    public static boolean isChinaRoom(){
        boolean bRet = false;
    ...
    private static Intent vivoApi(Context context) {
        ...
        float version = NumUtils.parseFloat(getSystemProperty(VIVO_VERSION_NAME));
        if(version >= 4.0f){
    ...
    private static Intent meitu(Context context) {
    ...
    public void start(int requestCode) {
        ...
        if (MARK.contains("huawei")) {
            ...
            intent = meitu(mSource.getContext());
        } else {
