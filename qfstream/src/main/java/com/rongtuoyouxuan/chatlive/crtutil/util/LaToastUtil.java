...
public class LaToastUtil {
    ...
    private static final LaToastUtil DEFAULT_MAKER = make();
    ...
    @NonNull
    public static LaToastUtil make() {
        return new LaToastUtil();
    }


    @NonNull
    public final LaToastUtil setMode(@MODE String mode) {
        mMode = mode;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setGravity(final int gravity, final int xOffset, final int yOffset) {
        mGravity = gravity;
        mXOffset = xOffset;
        mYOffset = yOffset;
        return this;
    ...
    @NonNull
    public final LaToastUtil setBgColor(@ColorInt final int backgroundColor) {
    ...
    @NonNull
    public final LaToastUtil setBgResource(@DrawableRes final int bgResource) {
        mBgResource = bgResource;
        return this;
    }

    @NonNull
    public final LaToastUtil setTextColor(@ColorInt final int msgColor) {
        mTextColor = msgColor;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setTextSize(final int textSize) {
        mTextSize = textSize;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setDurationIsLong(boolean isLong) {
        this.isLong = isLong;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setLeftIcon(@DrawableRes int resId) {
     ...
     */
    @NonNull
    public final LaToastUtil setLeftIcon(@Nullable Drawable drawable) {
        mIcons[0] = drawable;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setTopIcon(@DrawableRes int resId) {
        return setTopIcon(ContextCompat.getDrawable(Utils.getApp(), resId));
    }


    @NonNull
    public final LaToastUtil setTopIcon(@Nullable Drawable drawable) {
        mIcons[1] = drawable;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setRightIcon(@DrawableRes int resId) {
     ...
     */
    @NonNull
    public final LaToastUtil setRightIcon(@Nullable Drawable drawable) {
        mIcons[2] = drawable;
        return this;
    }

    @NonNull
    public final LaToastUtil setBottomIcon(int resId) {
        return setBottomIcon(ContextCompat.getDrawable(Utils.getApp(), resId));
    }


    @NonNull
    public final LaToastUtil setBottomIcon(@Nullable Drawable drawable) {
        mIcons[3] = drawable;
        return this;
    }
    ...
    @NonNull
    public final LaToastUtil setNotUseSystemToast() {
    ...
    @NonNull
    public static LaToastUtil getDefaultMaker() {
    ...
    private View tryApplyUtilsToastView(final CharSequence text) {
        ...
        View toastView = ViewUtils.layoutId2View(R.layout.utils_toast_view);
    ...
    public static void cancel() {
        ThreadUtils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (sWeakToast != null) {
                    final IToast iToast = LaToastUtil.sWeakToast.get();
                    if (iToast != null) {
                        iToast.cancel();
                    }
                    sWeakToast = null;
    ...
    private static void show(@Nullable final CharSequence text, final int duration, final LaToastUtil utils) {
        show(null, getToastFriendlyText(text), duration, utils);
    }

    private static void show(@NonNull final View view, final int duration, final LaToastUtil utils) {
    ...
    private static void show(@Nullable final View view,
                             ...
                             final int duration,
                             @NonNull final LaToastUtil utils) {
        ThreadUtils.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                cancel();
                IToast iToast = newToast(utils, text);
                if (iToast == null) return;
                LaToastUtil.sWeakToast = new WeakReference<>(iToast);
                if (view != null) {
    ...
    private static IToast newToast(LaToastUtil toastUtils, CharSequence text) {
        try {
...
//        }
            if (text != null) {
                Toast.makeText(ActivityUtils.getTopActivity(), text, Toast.LENGTH_SHORT)
                        .show();
            }
        } catch (Exception e) {
        }
    ...
    static final class SystemToast extends AbsToast {
        ...
        SystemToast(LaToastUtil toastUtils) {
            super(toastUtils);
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
                try {
    ...
    static final class WindowManagerToast extends AbsToast {
        ...
        WindowManagerToast(LaToastUtil toastUtils, int type) {
            super(toastUtils);
        ...
        WindowManagerToast(LaToastUtil toastUtils, WindowManager wm, int type) {
            super(toastUtils);
            mParams = new WindowManager.LayoutParams();
            mWM = wm;
            mParams.type = type;
    ...
    static final class ActivityToast extends AbsToast {
        ...
        ActivityToast(LaToastUtil toastUtils) {
            super(toastUtils);
        }
        ...
        private IToast showWithActivityWindow(Activity activity, int duration) {
            WindowManagerToast wmToast = new WindowManagerToast(mToastUtils, ActivityUtils.getTopActivity().getWindowManager(), WindowManager.LayoutParams.LAST_APPLICATION_WINDOW);
        ...
        private void showWithActivityView(final Activity activity, final int index, boolean useAnim) {
            final Window window = ActivityUtils.getTopActivity().getWindow();
            if (window != null) {
    ...
    static abstract class AbsToast implements IToast {
        ...
        protected LaToastUtil mToastUtils;
        protected View mToastView;

        AbsToast(LaToastUtil toastUtils) {
