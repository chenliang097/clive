package com.rongtuoyouxuan.chatlive.stream.view;
...
//                设置文字
                ...
                if (fontSize != 0.0f) {
                    float fontScale = tv.getContext().getResources().getDisplayMetrics().scaledDensity;
                    fontSize = (int) (fontSize * fontScale + 0.5f);
                } else {
