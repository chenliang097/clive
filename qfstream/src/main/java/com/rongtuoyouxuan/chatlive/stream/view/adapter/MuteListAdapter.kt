...
class MuteListAdapter: BaseQuickAdapter<RoomManagerMuteListBean.ItemBean, BaseViewHolder>, LoadMoreModule {
    private var type:Int = 0
    constructor(layoutId:Int, type:Int):super(layoutId){
        this.type =type
    }

    override fun convert(holder: BaseViewHolder, item: RoomManagerMuteListBean.ItemBean) {
