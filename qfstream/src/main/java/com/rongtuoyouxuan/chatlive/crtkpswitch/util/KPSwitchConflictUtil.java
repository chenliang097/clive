 ...
 */
package com.rongtuoyouxuan.chatlive.crtkpswitch.util;
...
import com.rongtuoyouxuan.chatlive.crtkpswitch.handler.KPSwitchPanelLayoutHandler;
import com.rongtuoyouxuan.chatlive.crtkpswitch.handler.KPSwitchRootLayoutHandler;
...
public class KPSwitchConflictUtil {
    ...
    public static void attach(final View panelLayout,
            /* Nullable **/final View showKeyboardBtn,
            /* Nullable **/final View switchPanelKeyboardBtn,
            /* Nullable **/final View focusView,
            /* Nullable **/final SwitchClickListener switchClickListener) {
        final Activity activity = (Activity) panelLayout.getContext();
        ...
        if (showKeyboardBtn != null) {
            showKeyboardBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (switchClickListener != null) {
                        showKeyboard(panelLayout, focusView);
                        switchClickListener.onClickSwitch(v, false);
                    }
                }
            });
