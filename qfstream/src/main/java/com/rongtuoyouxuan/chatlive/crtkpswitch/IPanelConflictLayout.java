 ...
 */
package com.rongtuoyouxuan.chatlive.crtkpswitch;
...
public interface IPanelConflictLayout {
     ...
     * Keyboard->Panel
     *
     * @see com.rongtuoyouxuan.chatlive.crtkpswitch.util.KPSwitchConflictUtil#showPanel(android.view.View)
     */
    void handleShow();
     ...
     * Panel->Keyboard
     *
     * @see com.rongtuoyouxuan.chatlive.crtkpswitch.util.KPSwitchConflictUtil#showKeyboard
     */
    void handleHide();
     ...
     * @see com.rongtuoyouxuan.chatlive.crtkpswitch.handler.KPSwitchPanelLayoutHandler#resetToRecommendPanelHeight
     * @see com.rongtuoyouxuan.chatlive.crtkpswitch.util.KeyboardUtil#getValidPanelHeight(android.content.Context)
     */
