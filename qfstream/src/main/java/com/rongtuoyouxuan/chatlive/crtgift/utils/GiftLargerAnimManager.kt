package com.rongtuoyouxuan.chatlive.crtgift.utils
...
class GiftLargerAnimManager {
    ...
    //观察者
    val msgObserver: com.rongtuoyouxuan.chatlive.crtgift.utils.SingleLiveEvent<com.rongtuoyouxuan.chatlive.crtgift.utils.Event<GiftLargerAnimEntity>> =
        com.rongtuoyouxuan.chatlive.crtgift.utils.SingleLiveEvent()
        ...
        timeTask = Runnable {
            synchronized(largerAnimList) {
                if (status) {
                    ...
                    msgObserver.postValue(
                        com.rongtuoyouxuan.chatlive.crtgift.utils.Event(
                            largerAnimList.poll()
                        )
                    )
                }
