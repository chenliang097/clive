...
import com.rongtuoyouxuan.chatlive.crtutil.util.ViewTools
import com.rongtuoyouxuan.chatlive.crtgift.AnimListener
import com.rongtuoyouxuan.chatlive.crtgift.BaseEffects
import com.rongtuoyouxuan.chatlive.crtgift.GiftAnimator
import com.rongtuoyouxuan.chatlive.crtgift.SwitchAnimationListener
import com.rongtuoyouxuan.chatlive.crtgift.SwitchLayout
...
class GiftShowView @JvmOverloads constructor(
    ...
    private var mtvGiftNumOne: com.rongtuoyouxuan.chatlive.crtgift.widget.GiftColorTextView
    ...
    fun action() {
        if (isWaitOutStatus && isHaveComboGift(currentGiftShow)) { //连击等待状态, 唤醒连击
            ...
            checkPlayMagicQueue(currentGiftShow!!) {
                postDelayed(startBgOutAnimRunnable, com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.GIFT_EXIT_DURATION_DELAY)
            }
        }
    ...
    private fun startPlayBgInAnim(giftShow: GiftEntity) {
        oneAnim = GiftAnimator.createFlyFromLtoR(com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.GIFT_BG_IN_DURATION, BaseEffects.overInter)
    ...
    private fun startPlayMagicTextAnim(giftShow: GiftEntity) {
        ...
        val scaleAnimation = ScaleAnimation(
            com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.MagicTextBigScale,
            com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.MagicTextNormalScale,
            com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.MagicTextBigScale,
            com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.MagicTextNormalScale,
        ...
        scaleAnimation.duration = com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.GIFT_NUM_ADD_DURATION
    ...
    private fun startBgOutAnim() {
        ...
        builder.view = rlOne
        builder.duration = com.rongtuoyouxuan.chatlive.crtgift.interfaces.IGiftShowManager.GIFT_EXIT_DURATION
