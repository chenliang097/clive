...
class NotificationControlManager {
    ...
    fun isOpenNotification(): Boolean {
        val notificationManager: NotificationManagerCompat =
            NotificationManagerCompat.from(
                com.rongtuoyouxuan.chatlive.qfcommon.notification.ForegroundActivityManager.getInstance().getCurrentActivity()!!
            )
    ...
    fun openNotificationInSys() {
        val context = com.rongtuoyouxuan.chatlive.qfcommon.notification.ForegroundActivityManager.getInstance().getCurrentActivity()!!
