...
import com.rongtuoyouxuan.chatlive.qfcommon.share.exception.UmengPlatformInstallException;
import com.rongtuoyouxuan.chatlive.qfcommon.share.exception.UmengPlatformInstallException;
...
public class RxUmengSocial {
    ...
    public void register(Context context, UmengSocialRegisterCallback registerCallback,
                         UmengSocialResumeCallback callback) {
    ...
    public void register(Context context, UMShareConfig config, UmengSocialRegisterCallback registerCallback,
                         UmengSocialResumeCallback resumeCallback) {
    ...
    public Observable<SHARE_MEDIA> shareUrl(Activity activity, final String title, final String message,
                                            final UMImage image, final String url) {
     ...
     * @return
     */
    private Observable<SHARE_MEDIA> createShareAction(final Activity activity,
                                                      final Function<ShareAction, ShareAction> function) {
