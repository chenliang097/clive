...
import com.rongtuoyouxuan.chatlive.crtbiz2.model.gift.GiftLargerAnimEntity
...
import com.rongtuoyouxuan.chatlive.qfcommon.player.exo.texture.EPlayerTextureView
import com.rongtuoyouxuan.chatlive.qfcommon.player.exo.texture.EPlayerTextureView2
import com.rongtuoyouxuan.chatlive.qfcommon.util.AnimUtil
...
class GiftLargerAnimPlayView : FrameLayout {
    ...
    init {
        inflate(context, com.rongtuoyouxuan.chatlive.stream.R.layout.gift_big_animation_view_layout, this)
        containerMp4 = findViewById(com.rongtuoyouxuan.chatlive.stream.R.id.containerMp4)
    }
