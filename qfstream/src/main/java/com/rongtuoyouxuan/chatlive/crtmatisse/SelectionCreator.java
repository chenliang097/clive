...
import com.rongtuoyouxuan.chatlive.crtmatisse.ui.ZhiJiSelectorActivity;
...
public final class SelectionCreator {
     ...
     * 1. {@link com.rongtuoyouxuan.chatlive.crtmatisse.engine.impl.GlideEngine}
     * 2. {@link com.rongtuoyouxuan.chatlive.crtmatisse.engine.impl.PicassoEngine}
    ...
    public SelectionCreator setJump2Pre(boolean jump2Pre){
        mSelectionSpec.jump2PreView = jump2Pre;
        return this;
    }

    public SelectionCreator videoPreViewEnable(boolean enable){
        mSelectionSpec.videoPreViewEnable = enable;
        return this;
    }
...
//        Intent intent = new Intent(activity, MatisseActivity.class);
        Intent intent = new Intent(activity, ZhiJiSelectorActivity.class);
