 ...
 */
package com.rongtuoyouxuan.chatlive.crtmatisse.internal.ui.widget;
...
//        mStrokePaint.setColor(color);
        mUnCheckDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.icon_live_check_box_discover, context.getTheme());
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.icon_check_box_checked, context.getTheme());
    }
...
//        setAlpha(mEnabled ? 1.0f : 0.5f);
        ...
        if (mChecked) {
            setImageResource(R.drawable.icon_check_box_checked);
        } else {
            setImageResource(R.drawable.icon_live_check_box_discover);
        }
    }
