 ...
 */
package com.rongtuoyouxuan.chatlive.crtmatisse.internal.ui;
...
import com.rongtuoyouxuan.chatlive.crtuikit.BaseStatusBarFragmentActivity;
...
import com.rongtuoyouxuan.chatlive.crtmatisse.internal.ui.adapter.PreviewPagerAdapter;
import com.rongtuoyouxuan.chatlive.crtmatisse.internal.ui.widget.CheckRadioView;
import com.rongtuoyouxuan.chatlive.crtmatisse.internal.ui.widget.CheckView;
...
import com.rongtuoyouxuan.chatlive.crtmatisse.internal.utils.Platform;
import com.rongtuoyouxuan.chatlive.crtmatisse.listener.OnFragmentInteractionListener;
import com.rongtuoyouxuan.chatlive.stream.R;

public abstract class BasePreviewActivity extends BaseStatusBarFragmentActivity implements View.OnClickListener,
    ...
    private void updateApplyButton() {
        ...
        if (selectedCount == 0) {
            ...
            mButtonApply.setTextColor(getResources().getColor(R.color.c_select_disable));
        } else if (selectedCount == 1 && mSpec.singleSelectionModeEnabled()) {
            mButtonApply.setText(R.string.button_sure_default);
            mButtonApply.setEnabled(true);
            mButtonApply.setBackgroundResource(R.drawable.bg_shape_apply);
            mButtonApply.setTextColor(getResources().getColor(R.color.white));
        } else {
            mButtonApply.setEnabled(true);
