...
import com.rongtuoyouxuan.chatlive.biz2.model.mine.response.VersionInfoModel
...
interface ChatIMServer {
     ...
     */
    @POST("/report/save")
    fun saveReport(@Body saveReportRequest: SaveReportRequest): Call<BaseModel>
     ...
     */
    @POST("/group/leave")
    fun quitGroup(@Body groupRequest: GroupRequest): Call<BaseModel>
    ...
    fun registerDevice(@Body registerDeviceRequest: RegisterDeviceRequest): Call<BaseModel>
     ...
     */
    @POST("/chatroom/mute")
    fun bannedChatRoomAllUser(@Body bannedRequest: BannedRequest): Call<BaseModel>
