package com.rongtuoyouxuan.chatlive.biz2.model.gift
...
data class GiftPanelResData(val data: GiftPanelRes) : BaseModel()

data class GiftResourceListRes(val timestamp: Long? = 0, val gift: ArrayList<String>?)

data class GiftResponseData(val data: GiftResourceListRes?) : BaseModel()

data class CarResourceListRes(val timestamp: Long? = 0, val car: ArrayList<String>?)

data class CarResponseData(val data: CarResourceListRes?) : BaseModel()
...
data class GiftLuckyInfoData(val data: GiftLuckyInfoRes) : BaseModel()
...
data class GiftBagData(val data: GiftBagEntity) : BaseModel()