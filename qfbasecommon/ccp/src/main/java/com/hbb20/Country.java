...
public class Country implements Comparable<Country> {
    ...
    public static void loadDataFromXML(Context context, CountryCodePicker.Language language) {
        ...
        try {
            ...
            InputStream ins = context.getResources().openRawResource(context.getResources().getIdentifier(language.toString().toLowerCase(Locale.ENGLISH), "raw", context.getPackageName()));
    ...
    public static Country getCountryName(Context context, String currentLang, String namecode) {
        return getCountryForNameCodeFromLibraryMasterList(context, getCountryLanguage(currentLang), namecode);
    }

    public static CountryCodePicker.Language getCountryLanguage(String language) {
        if (language.equals("en")) {
            return CountryCodePicker.Language.ENGLISH;
        } else if (language.equals("zh")) {
            return CountryCodePicker.Language.CHINESE_SIMPLIFIED;
        } else if (language.equals("vi")) {
            return CountryCodePicker.Language.VIETNAMESE;
        } else if (language.equals("ru")) {
            return CountryCodePicker.Language.RUSSIAN;
        } else if (language.equals("ja")) {
            return CountryCodePicker.Language.JAPANESE;
        } else if (language.equals("ko")) {
            return CountryCodePicker.Language.KOREAN;
        } else if (language.equals("ar")) {
            return CountryCodePicker.Language.ARABIC;
        } else if (language.equals("zhtw")) {
            return CountryCodePicker.Language.CHINESE_TRADITIONAL;
        } else if (language.equals("de")) {
            return CountryCodePicker.Language.GERMAN;
        } else if (language.equals("es")) {
            return CountryCodePicker.Language.SPANISH;
        } else if (language.equals("pt")) {
            return CountryCodePicker.Language.PORTUGUESE;
        } else if (language.equals("fr")) {
            return CountryCodePicker.Language.FRENCH;
        } else if (language.equals("th")) {
            return CountryCodePicker.Language.ENGLISH;
        } else if (language.equals("in")) {
            return CountryCodePicker.Language.INDONESIA;
        } else {
            return CountryCodePicker.Language.ENGLISH;
        }
    }
     ...
     * @return
     */
    public static int getFlagResID(String nameCode) {
        switch (nameCode.toLowerCase()) {
...
//                return R.drawable.flag_saint_barthelemy;// custom
    ...
    public static List<Country> getLibraryMasterCountriesEnglish() {
        ...
        countries.add(new Country("bl", "970", "Palestine"));
    ...
    public int getFlagID() {
        return getFlagResID(this.getNameCode());
    }
