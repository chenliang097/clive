...
public class CountryCodePicker extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        setOnClickListener(countryCodeHolderClickListener);
    }
...
//            displayText += "+" + selectedCountry.getPhoneCode();
            if(selectedCountry != null){
                displayText +=  selectedCountry.getName();
            }else{
...
//            displayText += "+" + selectedCountry.getPhoneCode();
    ...
    private void updateFormattingTextWatcher() {
        if (getEditText_registeredCarrierNumber() != null && selectedCountry != null) {
            ...
            //text watcher stops working when it finds item_tab_common_normal digit character in previous phone code. This will reset its function
