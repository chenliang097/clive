...
import static com.rongtuoyouxuan.chatlive.log.upload.Utils.checkNotNull;
...
final class ULogger {
    ...
    @NonNull private static Printer printer = new ULoggerPrinter();
    ...
    public static void printer(@NonNull Printer printer) {
        ULogger.printer = checkNotNull(printer);
    }
