...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_wheelview_textColorOut, 0xFFA6B0BD);
            textColorCenter = a.getColor(R.styleable.pickerview_wheelview_textColorCenter, 0xFF1D212C);
            dividerColor = a.getColor(R.styleable.pickerview_wheelview_dividerColor, 0x59EDEDED);
