...
import com.rongtuoyouxuan.chatlive.biz2.oss.OssBiz;
import com.rongtuoyouxuan.chatlive.biz2.oss.OssPathModel;
...
public class OssUploadClient {
    ...
    private static volatile OssUploadClient instance;
    ...
    public void init(final Context context, final RequestListener<OssPathModel> listener) {
        OssBiz.getInstance().getOssConfig(null, new RequestListener<OssPathModel>() {
            @Override
            public void onSuccess(String reqId, OssPathModel ossPathModel) {
                mBasePath = "http://assets.rongtuolive.com/";
            ...
            public void onFailure(String reqId, String errCode, String msg) {
                listener.onFailure(reqId, errCode, reqId);
